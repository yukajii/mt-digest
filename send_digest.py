...
Sends a markdown digest generated by **mt_arxiv_digest.py** via Buttondown.
...
3. Call **/send** to deliver the message to *all* active subscribers.
...
# ---------------------------------------------------------------------------
# 2⃣  Send e-mail (no preview)
# ---------------------------------------------------------------------------
print("⏳ Sending to subscribers…")

send_resp = requests.post(
    f"{BTN_API}/emails/{email_id}/send",   # ← changed from /send-draft
    headers=headers,
